...
The state space is formally described in Equation \ref{eqStateSpace}, where every vector $s \in \mathbb{S}$ $(p, v, \alpha, \omega)$, where $p$ consists of a cart position, $v$ cart velocity, $\alpha$ pole angle, $\omega$ and pole angular velocity.
